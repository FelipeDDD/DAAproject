...
try{
  ...
  characterId=available.find(c=>Date.now()-c.lastSeen>=15_000)?.characterId;
  ...
  console.log('PASS: concurrent reservation, owner-only updates/release and reassignment after release.');
}finally{
