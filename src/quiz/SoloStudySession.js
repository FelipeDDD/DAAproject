export class SoloStudySession {
  constructor(questions) {
    if(!Array.isArray(questions)||!questions.length)throw new Error('A study session needs at least one question.');
    this.questions=questions;this.index=0;this.correctCount=0;
